                    ...
                    <div className={`${styles.footerRow} ${styles.footerRowOne}`}>
                        ...
                        <div className={styles.footerSocial}>
                            <a target="_blank" href="https://www.linkedin.com/in/melissavg/" rel="noopener noreferrer">
                                ...
                                alt="Melissa Velasquez Greene LinkedIn Profile" />
                            </a>
                            <a target="_blank" href="https://github.com/melissa0191" rel="noopener noreferrer">
                                ...
                                alt="Melissa Velasquez Greene GitHub Profile" />
                            </a>
                            <a target="_blank" href="mailto:melissavelasquezbrito@gmail.com" rel="noopener noreferrer">
                                <img className={styles.footerIcon} src={mailIcon} id={styles.mailIcon}
                                alt="Melissa Velasquez Greene Direct Email Message" />
                            </a>
                        </div>
                    </div>
                    <div className={styles.footerRowTwo}>
                        <h2 className={`${styles.headingTwo}`}>Melissa Velasquez Greene</h2>
                    </div>
                </div>
            <div className={styles.footerLower}>
                © Copyright 2024. Made by Melissa Velasquez Greene
            </div>
            </div>
        </footer>
    )
